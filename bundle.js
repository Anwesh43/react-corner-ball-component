...
var _StateObj = require('./StateObj');

var _StateObj2 = _interopRequireDefault(_StateObj);
...
var CornerBall = function (_Component) {
	_inherits(CornerBall, _Component);

	function CornerBall(props) {
		_classCallCheck(this, CornerBall);

		var _this = _possibleConstructorReturn(this, (CornerBall.__proto__ || Object.getPrototypeOf(CornerBall)).call(this, props));

		_this.sobj = new _StateObj2.default();
		_this.getIntialState();
		return _this;
	}

	_createClass(CornerBall, [{
		key: 'getIntialState',
		value: function getIntialState() {
			var w = window.innerWidth,
			    h = window.innerHeight;
			var size = Math.min(w, h) / 5;
			var origX = this.props.i % 2 * (w - size),
			    origY = Math.floor(this.props.i / 2) * (h - size);
			this.state = { origX: origX, origY: origY, size: size, x: origX, y: origY };
		}
	}, {
		...
		value: function componentDidMount() {
			...
			window.onresize = function () {
				var w = window.innerWidth,
				    h = window.innerHeight;
				var size = Math.min(w, h) / 5;
				var factor = size / _this2.state.size;
				console.log(size / _this2.state.size);
				var reorg = function reorg(a) {
					return a * factor;
				};
				var reorgObj = function reorgObj(obj) {
					var newObj = {};
				...
				_this2.setState(reorgObj(_this2.state));
			};
		}
	}, {
		key: 'handleClick',
		value: function handleClick() {
			...
			var w = window.innerWidth,
			    h = window.innerHeight;
			this.sobj.startUpdating(function () {
				_Animator.animator.start(function () {
					return _this3.sobj.update(function (sc) {
						console.log(sc);
						var sc1 = Math.min(0.5, sc) * 2;
						var sc2 = Math.min(0.5, Math.max(0, sc - 0.5)) * 2;
						var _state = _this3.state,
						    origX = _state.origX,
						    origY = _state.origY,
						    size = _state.size;

						_this3.setState({ x: origX + (w / 2 - size / 2 - origX) * sc1, y: origY + (h / 2 - size / 2 - origY) * sc2 });
					});
				});
			});
		}
		...
		value: function render() {
			return _react2.default.createElement('div', { onClick: this.handleClick.bind(this), style: { width: this.state.size, height: this.state.size, borderRadius: "50%", position: "absolute", left: this.state.x, top: this.state.y,
					background: '#1976D2' } });
		}
	}]);
...
exports.default = CornerBall;

},{"./Animator":1,"./StateObj":4,"react":29}],3:[function(require,module,exports){
'use strict';
...
var _CornerBallComponent = require('./CornerBallComponent');

var _CornerBallComponent2 = _interopRequireDefault(_CornerBallComponent);
...
var CornerBallGroupComponent = function (_Component) {
	_inherits(CornerBallGroupComponent, _Component);

	function CornerBallGroupComponent(props) {
		_classCallCheck(this, CornerBallGroupComponent);

		return _possibleConstructorReturn(this, (CornerBallGroupComponent.__proto__ || Object.getPrototypeOf(CornerBallGroupComponent)).call(this, props));
	}

	_createClass(CornerBallGroupComponent, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				[0, 1, 2, 3].map(function (num) {
					return _react2.default.createElement(_CornerBallComponent2.default, { i: num, key: 'ball_' + num });
				})
			);
		}
	}]);

	return CornerBallGroupComponent;
}(_react.Component);

exports.default = CornerBallGroupComponent;

},{"./CornerBallComponent":2,"react":29}],4:[function(require,module,exports){
"use strict";
...
var StateObj = function () {
	...
	_createClass(StateObj, [{
		...
		key: "startUpdating",
		value: function startUpdating(cb) {
			if (this.dir == 0) {
...
var _CornerBallGroupComponent = require('./CornerBallGroupComponent');

var _CornerBallGroupComponent2 = _interopRequireDefault(_CornerBallGroupComponent);
	...
	_createClass(Main, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_CornerBallGroupComponent2.default, null)
			);
		}
	}]);
...
},{"./CornerBallGroupComponent":3,"react":29,"react-dom":25}],6:[function(require,module,exports){
/**
...
},{"./emptyFunction":10,"_process":20}],20:[function(require,module,exports){
...
},{"fbjs/lib/ExecutionEnvironment":6,"fbjs/lib/containsNode":9,"fbjs/lib/emptyFunction":10,"fbjs/lib/emptyObject":11,"fbjs/lib/getActiveElement":12,"fbjs/lib/invariant":15,"fbjs/lib/shallowEqual":18,"object-assign":26,"react":29}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":20,"fbjs/lib/emptyFunction":10,"fbjs/lib/emptyObject":11,"fbjs/lib/invariant":15,"fbjs/lib/warning":19,"object-assign":30,"prop-types/checkPropTypes":21}],28:[function(require,module,exports){
/** @license React v16.4.2
...
},{"fbjs/lib/emptyFunction":10,"fbjs/lib/emptyObject":11,"fbjs/lib/invariant":15,"object-assign":30}],29:[function(require,module,exports){
(function (process){
'use strict';
